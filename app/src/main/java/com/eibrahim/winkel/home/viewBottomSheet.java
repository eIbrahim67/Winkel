...
public class viewBottomSheet extends BottomSheetDialogFragment {
    ...
    public viewBottomSheet(RecyclerView recyclerView_filter, RecyclerView recyclerView_items, RecyclerviewVisibility recyclerviewVisibility, DoFilter doFilter) {
